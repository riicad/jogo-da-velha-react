...
const JogoDaVelha = () => {
    ...
    const checkWin = () => {
        ...
        else if(data[2]===data[5] && data[5]===data[8] && data[8]!=="")
        {
         ...
         else if (data[2]===data[1] && data[1]===data[2] && data[2]!==""){
            won(data[2]);
        }
    ...
    const won = (winner) => {
        setLock(true);
        if(winner==="x"){
            titleRef.current.innerHTML = `PARABÉNS: <img src='${x_icon}'> Wins`;
        }
        else
        {
             titleRef.current.innerHTML = `PARABÉNS: <img src='${circle_icon}'> Wins`;
        }
    }
